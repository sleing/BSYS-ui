<template>
    <div class="ele-body">
        <a-card :bordered="false">
            <vxe-grid ref='tsActivityGrid' v-bind="gridOptions" class="my-grid66">
                <!--搜索表单 -->
                <template #form>
                    <a-form
                            :model="where"
                        ...
                        <a-row>
                                        ...
                                        <a-col  :lg="6" :md="12" :sm="24"
                                            ...
                                            <a-form-item label="序号:" name="activityIndex">
                                                                                                    <a-input-number
                                                            v-model:value="where.activityIndex"
                                                            placeholder="请输入序号"
                                                            :min="0"
                                                            :step="1"
                                                            class="ele-fluid">
                                        ...
                                        <a-col  :lg="6" :md="12" :sm="24"
                                            ...
                                            <a-form-item label="活动类型:" name="activityType">
                                                                                                    <a-input
                                                            v-model:value="where.activityType"
                                                            :maxlength="255"
                                                            placeholder="请输入活动类型"
                                                            allow-clear
                                                            class="ele-fluid"
                                        ...
                                        <a-col  :lg="6" :md="12" :sm="24"
                                            ...
                                            <a-form-item label="活动时间:" name="activityDate">
                                                                                                    <a-date-picker
                                                            v-model:value="where.activityDate"
                                                            placeholder="请选择活动时间"
                                        ...
                                        <a-col  v-if="searchExpand"  :lg="6" :md="12" :sm="24"
                                            ...
                                            <a-form-item label="活动主持人:" name="activityHostId">
                                                                                                    <m-entity-select
                                                            v-model:value="where.activityHostId"
                                                            placeholder="请选择活动主持人"
                                                            module="tsactivityEntity"
                                        ...
                                        <a-col  v-if="searchExpand"  :lg="6" :md="12" :sm="24"
                                            ...
                                            <a-form-item label="活动地点:" name="activityAdd">
                                                                                                    <a-input
                                                            v-model:value="where.activityAdd"
                                                            :maxlength="255"
                                                            placeholder="请输入活动地点"
                                                            allow-clear
                                                            class="ele-fluid"
                                        ...
                                        <a-col  v-if="searchExpand"  :lg="6" :md="12" :sm="24"
                                            ...
                                            <a-form-item label="参与人员:" name="participant">
                                                                                                    <a-input
                                                            v-model:value="where.participant"
                                                            :maxlength="255"
                                                            placeholder="请输入参与人员"
                                                            allow-clear
                                                            class="ele-fluid"
                                        ...
                                        <a-col  v-if="searchExpand"  :lg="6" :md="12" :sm="24"
                                            ...
                                            <a-form-item label="活动内容:" name="activityContent">
                                                                                                    <a-input
                                                            v-model:value="where.activityContent"
                                                            :maxlength="255"
                                                            placeholder="请输入活动内容"
                                                            allow-clear
                                                            class="ele-fluid"
                                        ...
                                        <a-col  v-if="searchExpand"  :lg="6" :md="12" :sm="24"
                                            ...
                                            <a-form-item label="活动评价:" name="activityEval">
                                                                                                    <a-input
                                                            v-model:value="where.activityEval"
                                                            :maxlength="255"
                                                            placeholder="请输入活动评价"
                                                            allow-clear
                                                            class="ele-fluid"
                                        ...
                                        <a-col  v-if="searchExpand"  :lg="6" :md="12" :sm="24"
                                            ...
                                            <a-form-item label="活动资料:" name="activityFile">
                                                                                                    <a-input
                                                            v-model:value="where.activityFile"
                                                            :maxlength="255"
                                                            placeholder="请输入活动资料"
                                                            allow-clear
                                                            class="ele-fluid"
            ...
            <!--编辑弹窗-->
            <vxe-modal v-model="tsActivityListApp.editModalShowing" ref="tsActivityEditModal"
                       :title="gridOptions.showEditTitle"
                       id="tsActivityEditModal"
            ...
            >
                <template #default>
                    <div id="tsActivityEditModalContent">
                    </div>
                </template>
                <template #footer>
                    <div id="tsActivityEditModalFooter">
                    </div>
                    <teleport to="#tsActivityEditModalContent">
                        <tsActivity-edit ref="tsActivity-edit"/>
                    </teleport>
                </template>
            </vxe-modal>

            <!--查看弹窗-->
            <vxe-modal v-model="tsActivityListApp.viewModalShowing" :title="gridOptions.showDetailsTitle"
                       id="tsActivityViewModal"
                       width="600"
                       min-width="460"
                       min-height="320"
                       :destroy-on-close="true"
                       ...
                       show-footer show-zoom resize remember storage transfer dblclickZoom>
                <template #default>
                    <tsActivity-detail ref="tsActivity-detail"/>
                </template>
            </vxe-modal>
        </a-card>
    </div>
...
<script>
    ...
    import TsActivityEdit
        from "@/views/tms/tsactivityEntity/tsActivity/tsActivity-edit";
    import TsActivityDetail
        from "@/views/tms/tsactivityEntity/tsActivity/tsActivity-detail";
    import {
        PlusOutlined,
        DeleteOutlined,
        DownOutlined,
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const tsActivityGrid = ref({})// as VxeGridInstance
            // 搜索表单是否展开
            ...
            const tsActivityListApp = reactive({
            ...
            const gridOptions = reactive({
                ...
                proxyConfig: {
                    ...
                    ajax: {
                        ...
                        query: ({page, sorts, filters}) => {  // 接收 Promise
                            ...
                            //
                            const $grid = tsActivityGrid.value
                                $grid.queryParams = queryParams
                            return TsActivityService.findTsActivitys(queryParams).catch(error => {
                ...
                exportConfig: {
                    ...
                    exportMethod({options}) {
                        ...
                        // 开始服务端导出
                        return TsActivityService.findTsActivitysForExport(body).then(data => {
            ...
            provide('tsActivityListApp', tsActivityListApp)
            provide('gridOptions', gridOptions)

            /*TODO:新建事件*/
            const addEvent = () => {
                    tsActivityListApp.editModalShowing = true
                    tsActivityListApp.currentId = null;
                    tsActivityListApp.addModalForEdit = true;
                gridOptions.showEditTitle = "新建";
            }

            /*TODO:新建独立页*/
            const addEvent2 = () => {
                router.push(`/tms/tsactivityEntity/tsActivity/tsActivity-add`);
            }
            /*TODO:编辑事件*/
            const editEvent = (row) => {
                    tsActivityListApp.editModalShowing = true
                    tsActivityListApp.currentId = row.eid;
                    tsActivityListApp.editModalForEdit = true;
                gridOptions.showEditTitle = "编辑";
            }
            /*TODO:编辑独立页*/
            const editEvent2 = (eid) => {
                router.push(`/tms/tsactivityEntity/tsActivity/tsActivity-edit/${eid}`);
            }
            ...
            const viewEvent = (row) => {
                    tsActivityListApp.currentId = row.eid;
                    tsActivityListApp.viewModalShowing = true
                gridOptions.showDetailsTitle = '查看';
            }

            /*TODO:删除事件*/
            const deleteEvent = (row) => {
                    TsActivityService.deleteTsActivity(row.eid).then(() => {
