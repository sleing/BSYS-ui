<template>
    <div class="ele-body">
        <a-card :bordered="false">
            <vxe-grid ref='rewardGrid' v-bind="gridOptions" class="my-grid66">
                <!--搜索表单 -->
                <template #form>
                    <a-form
                            :model="where"
                        ...
                        <a-row>
                                        ...
                                        <a-col  :lg="6" :md="12" :sm="24"
                                                             :xs="24">
                                            <a-form-item label="指导教师:" name="instructors">
                                                                                                    <a-input
                                                            v-model:value="where.instructors"
                                                            :maxlength="255"
                                                            placeholder="请输入指导教师"
                                                            allow-clear
                                                            class="ele-fluid"
                                        ...
                                        <a-col  v-if="searchExpand"  :lg="6" :md="12" :sm="24"
                                                             :xs="24">
                                            <a-form-item label="证明文件:" name="evidence">
                                                                                                    <a-input
                                                            v-model:value="where.evidence"
                                                            :maxlength="255"
                                                            placeholder="请输入证明文件"
                                                            allow-clear
                                                            class="ele-fluid"
                                        ...
                                        <a-col  v-if="searchExpand"  :lg="6" :md="12" :sm="24"
                                                             :xs="24">
                                            <a-form-item label="时间:" name="year">
                                                                                                    <a-date-picker
                                                            v-model:value="where.year"
                                                            placeholder="请选择时间"
                                        ...
                                        <a-col  v-if="searchExpand"  :lg="6" :md="12" :sm="24"
                                                             :xs="24">
                                            <a-form-item label="举办单位:" name="organization">
                                                                                                    <a-input
                                                            v-model:value="where.organization"
                                                            :maxlength="255"
                                                            placeholder="请输入举办单位"
                                                            allow-clear
                                                            class="ele-fluid"
                                        ...
                                        <a-col  v-if="searchExpand"  :lg="6" :md="12" :sm="24"
                                                             :xs="24">
                                            <a-form-item label="获奖学生:" name="allStudents">
                                                                                                    <a-input
                                                            v-model:value="where.allStudents"
                                                            :maxlength="255"
                                                            placeholder="请输入获奖学生"
                                                            allow-clear
                                                            class="ele-fluid"
                                        ...
                                        <a-col  v-if="searchExpand"  :lg="6" :md="12" :sm="24"
                                                             :xs="24">
                                            <a-form-item label="获奖电话:" name="tel">
                                                                                                    <a-input
                                                            v-model:value="where.tel"
                                                            :maxlength="255"
                                                            placeholder="请输入获奖电话"
                                                            allow-clear
                                                            class="ele-fluid"
            ...
            <!--编辑弹窗-->
            <vxe-modal v-model="rewardListApp.editModalShowing" ref="rewardEditModal"
            ...
            >
                <template #default>
                    <div id="rewardEditModalContent">
                    </div>
                </template>
                <template #footer>
                    <div id="rewardEditModalFooter">
                    </div>
                    <teleport to="#rewardEditModalContent">
                        <reward-edit ref="reward-edit"/>
                    </teleport>
                </template>
            </vxe-modal>

            <!--查看弹窗-->
            <vxe-modal v-model="rewardListApp.viewModalShowing" :title="gridOptions.showDetailsTitle"
                       id="rewardViewModal"
                       width="600"
                       min-width="460"
                       min-height="320"
                       ...
                       show-footer show-zoom resize remember storage transfer dblclickZoom>
                <template #default>
                    <reward-detail ref="reward-detail"/>
                </template>
            </vxe-modal>
        </a-card>
    </div>
...
<script>
    ...
    import RewardEdit
        from "@/views/bms/rewardEntity/reward/reward-edit";
    import RewardDetail
        from "@/views/bms/rewardEntity/reward/reward-detail";
    import {
        PlusOutlined,
        DeleteOutlined,
        DownOutlined,
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const rewardGrid = ref({})// as VxeGridInstance
            // 搜索表单是否展开
            ...
            const gridOptions = reactive({
                ...
                proxyConfig: {
                    ...
                    ajax: {
                        ...
                        query: ({page, sorts, filters}) => {  // 接收 Promise
                            ...
                            //
                            const $grid = rewardGrid.value
                                $grid.queryParams = queryParams
                            return RewardService.findRewards(queryParams).catch(error => {
                ...
                exportConfig: {
                    ...
                    exportMethod({options}) {
                        ...
                        // 开始服务端导出
                        return RewardService.findRewardsForExport(body).then(data => {
            ...
            provide('rewardListApp', rewardListApp)
            provide('gridOptions', gridOptions)

            /*TODO:新建事件*/
            const addEvent = () => {
                    rewardListApp.editModalShowing = true
                    rewardListApp.currentId = null;
                    rewardListApp.addModalForEdit = true;
                gridOptions.showEditTitle = "新建";
            }

            /*TODO:新建独立页*/
            const addEvent2 = () => {
                router.push(`/bms/rewardEntity/reward/reward-add`);
            }
            /*TODO:编辑事件*/
            const editEvent = (row) => {
                    rewardListApp.editModalShowing = true
                    rewardListApp.currentId = row.eid;
                    rewardListApp.editModalForEdit = true;
                gridOptions.showEditTitle = "编辑";
            }
            /*TODO:编辑独立页*/
            const editEvent2 = (eid) => {
                router.push(`/bms/rewardEntity/reward/reward-edit/${eid}`);
            }
            ...
            const viewEvent = (row) => {
                    rewardListApp.currentId = row.eid;
                    rewardListApp.viewModalShowing = true
                gridOptions.showDetailsTitle = '查看';
            }

            /*TODO:删除事件*/
            const deleteEvent = (row) => {
                    RewardService.deleteReward(row.eid).then(() => {
